...
/**
 * 
 * 汉字转化为全拼,码表利用输入法的码表导出，汉字信息非常全，平时见到的汉字 转拼音的API只能处理几千个一级汉字，很多字都没有法查到，尤其是我自己的姓
 * 都查不到所以只好自己做一个汉字转拼音的API，该API除可以处理99％以上的汉字， 而且可以返回多音字的读音
 */
public class CnToSpellResource
{
